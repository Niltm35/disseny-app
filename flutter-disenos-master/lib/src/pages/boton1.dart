...
class _BottomSheetAwesomeState extends State<Boton1> {
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: currentIndex == index
                  ? Theme.of(context).primaryColor
                  : Colors.black12),
          color: hasVisited ? Theme.of(context).primaryColor : Colors.grey[700],
        ),
        child: Text(
          "${index + 1}",
          style: TextStyle(
            color: hasVisited ? Colors.white : Colors.white,
          ),
        ),
      ),
    );
